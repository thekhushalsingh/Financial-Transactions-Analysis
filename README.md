...
---
Here is the content formatted as a clean, professional README.md file. You can copy the code block below and save it as README.md in your project folder.
